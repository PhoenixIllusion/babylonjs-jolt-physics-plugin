...
export default (): SceneCallback => {
  ...
  const controller = (car.box.getScene().getPhysicsEngine()?.getPhysicsPlugin() as JoltJSPlugin).createMotorcycleVehicleController(car.physics, wheeledConfig, vehicleInput);
