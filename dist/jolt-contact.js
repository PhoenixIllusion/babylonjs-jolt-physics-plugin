...
export class ContactCollector {
    constructor(listener, reporter) {
        ...
        const withChecks = (inBody1, inBody2, type, afterCheck) => {
        ...
        const wrapContactRemove = (inBody1, inBody2) => {
        ...
        listener.OnContactRemoved = (shapeIdPair) => {
            shapeIdPair = Jolt.wrapPointer(shapeIdPair, Jolt.SubShapeIDPair);
