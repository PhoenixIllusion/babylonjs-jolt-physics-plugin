...
export function castJoltShape(shape) {
...
function getParentsRotation(object) {
...
function getMeshVertexData(object) {
...
export function createShape(type, parameters, _tmpVec) {
    const ep = (value) => {
